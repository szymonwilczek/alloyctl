...
static const struct alloy_driver_ops prime_ops = {
	.apply_dpi = prime_apply_dpi,
	.apply_polling = prime_apply_polling,
	.apply_colors = prime_apply_colors,
	.apply_brightness = prime_apply_brightness,
	.apply_buttons = prime_apply_buttons,
	.save = prime_save,
};
